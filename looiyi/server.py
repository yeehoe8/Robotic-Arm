...
from fastapi.responses import FileResponse # <-- ADDED THIS LINE
import numpy as np
...
# --- ADDED ROUTE TO SERVE THE DASHBOARD ---
@app.get("/")
def serve_dashboard():
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=8000) # <-- CHANGED HOST TO 0.0.0.0