...
def send_command(cmd: str):
    global usb_serial, SIMULATION_MODE
    if SIMULATION_MODE:
        return {"status": "simulated"}  # Hardware lock-out
...
def check_status():
    ...
    if SIMULATION_MODE:
        return {"status": "simulated"}  # Ignore hardware sensor while simulating
